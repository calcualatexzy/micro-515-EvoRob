#!/bin/bash
#SBATCH --job-name=ER_Final                # Job name
#SBATCH --output=logs/ER_Final_%j.out      # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/ER_Final_%j.err       # Standard error file
